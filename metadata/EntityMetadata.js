...
var EntityMetadata = /** @class */ (function () {
    ...
    EntityMetadata.prototype.compareEntities = function (firstEntity, secondEntity) {
        ...
        var isFirstEntityEmpty = this.isEntityIdMapEmpty(firstEntity);
        var isSecondEntityEmpty = this.isEntityIdMapEmpty(secondEntity);
     ...
     */
    EntityMetadata.prototype.isEntityIdMapEmpty = function (entity) {
     ...
     */
    EntityMetadata.prototype.getValueMap = function (entity, columns) {
    ...
    EntityMetadata.prototype.getValueDatabasePaths = function (entity) {
        return this.columns.reduce(function (query, column) {
            var columnValue = column.getEntityValue(entity);
     ...
     */
    EntityMetadata.prototype.convertPropertiesMapToDatabaseMap = function (entity) {
        var _this = this;
        var map = {};
        this.columns.forEach(function (column) {
            if (column.isVirtual)
                return;
            OrmUtils_1.OrmUtils.mergeDeep(map, column.createValueMap(column.getEntityValue(entity)));
        });
        this.relations.forEach(function (relation) {
            var relationValue = relation.getEntityValue(entity);
            if (relationValue instanceof Object)
                relationValue = relation.createValueMap(_this.convertPropertiesMapToDatabaseMap(relationValue));
            OrmUtils_1.OrmUtils.mergeDeep(map, relationValue);
        });
        return map;
    };
    /**
