...
var EntityNotFoundError = /** @class */ (function (_super) {
    ...
    function EntityNotFoundError(entityClass, criteria) {
        ...
        var className = (typeof entityClass === "string") ? entityClass : entityClass.constructor.name;
        var criteriaString = _this.stringifyCriteria(criteria);
        _this.message = "Could not find any entity of type \"" + className + "\" matching: " + criteriaString;
        return _this;
    }
