...
var RawSqlResultsToEntityTransformer = /** @class */ (function () {
    ...
    RawSqlResultsToEntityTransformer.prototype.transformRawResultsGroup = function (rawResults, alias) {
        ...
        var hasColumns = this.transformColumns(rawResults, alias, entity, alias.metadata);
        var hasRelations = this.transformJoins(rawResults, entity, alias);
        var hasRelationIds = this.transformRelationIds(rawResults, alias, entity);
        ...
        var hasOnlyVirtualPrimaryColumns = alias.metadata.primaryColumns.filter(function (column) { return column.isVirtual === false; }).length === 0; // todo: create metadata.hasOnlyVirtualPrimaryColumns
